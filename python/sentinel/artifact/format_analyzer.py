...
class FormatAnalyzer:
    ...
    def _detect_zip_format(self, filepath: str) -> str:
        ...
        try:
            ...
            return "pytorch"  # Extension fallback
    ...
    def analyze(self, filepath: str) -> FormatReport:
        ...
        # Dispatch to engines
        if fmt == "gguf":
            return self.gguf_engine.analyze(filepath)
        elif fmt == "safetensors":
            return self.safetensors_engine.analyze(filepath)
        elif fmt == "pytorch":
            return self.pytorch_engine.analyze(filepath)
        elif fmt == "onnx":
