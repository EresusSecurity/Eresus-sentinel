...
[red]╺━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╸[/red]"""
    ...
    platform_convert = platform_sub.add_parser("convert", help="convert structured inputs into Sentinel format")
    platform_convert.add_argument("input", nargs="?")
    platform_convert.add_argument("--target")
    platform_convert.add_argument("--from", dest="source_format")
    platform_convert.add_argument("--to", dest="target_format", default="sntl")
    platform_convert.add_argument("--return-format", default="json")
    platform_convert.add_argument("--schema")
    platform_convert.add_argument("--name")
    platform_convert.add_argument("--plan", action="store_true")
    platform_convert.add_argument("--inspect", action="store_true")
    platform_convert.add_argument("--check", action="store_true")
    platform_convert.add_argument("--recursive", action="store_true")
    platform_convert.add_argument("--source-formats", nargs="*")
    platform_convert.add_argument("--capabilities", action="store_true")
    platform_convert.add_argument("-o", "--output", default=argparse.SUPPRESS)
    platform_convert.set_defaults(func=cmd_platform, platform_action="convert")
    ...
    p = sub.add_parser("convert", help="convert structured inputs into Sentinel format")
    p.add_argument("input", nargs="?")
    p.add_argument("--target")
    p.add_argument("--from", dest="source_format")
    p.add_argument("--to", dest="target_format", default="sntl")
    p.add_argument("--return-format", default="json")
    ...
    p.add_argument("--source-formats", nargs="*")
    p.add_argument("--capabilities", action="store_true")
    p.add_argument("-o", "--output", default=argparse.SUPPRESS)
    p.set_defaults(func=cmd_platform, platform_action="convert")
